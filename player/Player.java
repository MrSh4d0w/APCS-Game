...
public class Player {
    ...
    private int getLocationX(){return locX;}// returns location of Player object
    private int getLocationY(){return locY;}// returns location of Player object
    private void setLocationX(int x){locX = x;}// sets location of Player object
    private void setLocationY(int y){locY = y;}// sets location of Player object
